...
public class mainClass implements Serializable{
    ...
    public static void main(String[] args)
    {
        ...
        c.compareOneStockToOtherStocks("AAPL");
...
//        }
        ...
        ArrayList<ArrayList<Double>> precentSet=new ArrayList<ArrayList<Double>>();
...
//                {
//                    sampleDate=new ArrayList<Date>();
//                    samplePercent=new ArrayList<Double>();
//                    currentStockName=Stockname;
//                }
//                else if(currentStockName==Stockname)
//                {
//
//                    sampleDate.add(date);
//                    samplePercent.add(percent);
//                }
//                else{
//                    dateSet.add(sampleDate);
//                    precentSet.add(samplePercent);
//                    sampleDate=new ArrayList<Date>();
//                    samplePercent=new ArrayList<Double>();
//                }
                System.out.println(arg0._1._1 + " => " + arg0._1._2 + " => " + arg0._2);
            }
        });
        for(ArrayList<Date> a:dateSet)
        {
            for(Date d:a)
            {
